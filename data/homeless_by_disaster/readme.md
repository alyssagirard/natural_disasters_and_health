# People left homeless from natural disasters - Data package

This data package contains the data that powers the chart ["People left homeless from natural disasters"](https://ourworldindata.org/grapher/number-homeless-from-natural-disasters?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website. It was downloaded on November 19, 2025.
...
#### Full citation
EM-DAT, CRED / UCLouvain (2025) – with major processing by Our World in Data. “Homeless – EM-DAT” [dataset]. EM-DAT, CRED / UCLouvain, “Natural disasters” [original data].
